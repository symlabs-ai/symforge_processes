# ForgeProcess: Ciclos de Raciocínio e Entrega de Valor
...
- **Estimativas por feature / VT**: `specs/roadmap/estimates.yml` (campo `tokens_estimated`);
- **Consolidação por ciclo**: `specs/roadmap/CYCLE_PLAN.md` (seção de custos por ciclo);
